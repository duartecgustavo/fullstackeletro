            ...
            <div className="bg-size-body">
                ...
                <div className="container-fluid">
                    ...
                    <div className="row d-flex align-items-center justify-content-center;">
                        ...
                        <form className="form-contato col-12 col-sm-12 col-md-8 col-lg-4 col-xl-4 p-4 mx-auto">
                            ...
                            <div>
                                ...
                                <textarea className="form-control" id="validationTextarea" placeholder="O que está pensando?"></textarea>
                            </div>
