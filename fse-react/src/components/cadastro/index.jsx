            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-sm-12 col-md-12 col-lg-6 col-lx-6 d-flex justify-content-center">
                        ...
                        <form className="form p-3 m-4" onSubmit={registerUser}>

                            <h2 className="text-cadastro text-center m-4 font-weight-bold">CADASTRO</h2>

                            <div className="form-group">
                                <label for="exampleInputEmail1" className="m-0">Nome</label>
                                <input type="text" className="form-control" id="exampleInputNome" name="name" placeholder="digite seu nome" />
                            </div>
                            <div className="form-group">
                                <label for="exampleInputEmail1" className="m-0">E-mail</label>
                            ...
                            <div className="form-group">
                                <label for="exampleInputPassword1" className="m-0">Senha</label>
                                <input type="password" className="form-control" id="exampleInputPassword1" name="senha" placeholder="digite sua senha" />
                            </div>
                            <div className="form-group">
                                <label for="exampleInputEmail1" className="m-0">Nascimento</label>
                            ...
                            <div className="form-group">
                                <label for="exampleInputPassword1" className="m-0">Cidade</label>
